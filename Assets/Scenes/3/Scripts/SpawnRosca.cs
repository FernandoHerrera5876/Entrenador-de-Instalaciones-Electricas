...
public class SpawnRosca : MonoBehaviour
{
    ...
    public SpawnLiza spawnLizaScript; // Referencia al script SpawnLiza
    ...
    {
        // Verifica si el collider tiene el tag "Broca" y si se puede instanciar
        if (other.CompareTag("Broca") && puedeInstanciar)
        {
            ...
            if (puntoDeAparicion != null && objetoAparecer != null)
            {
                ...
                GameObject objetoLizaInstanciado = spawnLizaScript.ObtenerObjetoInstanciado();
    ...
    {
        // Verifica si el objeto que salió del trigger tiene el tag "Broca"
        if (other.CompareTag("Broca"))
        {
