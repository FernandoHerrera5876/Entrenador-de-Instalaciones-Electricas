...
public class ActivarAnimacion4 : MonoBehaviour
{
    public Animator animacion1; // Asegúrate de asignar el primer Animator en el Inspector de Unity
    public string nombreAnimacion1 = "compresora2"; // Nombre de la primera animación a reproducir
    public string nombreAnimacion2 = "latav2"; // Nombre de la segunda animación a reproducir
    public float tiempoDesactivacion = 5f; // Tiempo después del cual se desactivan las animaciones
    public SpawnLatas scriptSpawn; // Referencia al script AparicionObjeto
